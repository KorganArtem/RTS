...
public class Waybill {
    ...
    public String  createWayBill(int DriverId, int carId, int companyId, String startDate, String endDate) throws ClassNotFoundException, SQLException { 
        ...
        try {
            ...
            System.out.println(startDate+"docs/"+fileName);
            OutputStream out = new FileOutputStream(startDate+"docs/"+fileName);
            doc.write(out);
            out.flush();
            out.close();
            return fileName;
